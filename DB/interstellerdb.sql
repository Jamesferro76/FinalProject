...
START TRANSACTION;
USE `interstellerdb`;
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (1, '1993-09-21', 'admin', 'Male', 'Admin', 'Jones', 1, 1, NULL, 1, NULL, NULL, '87');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (2, '1992-06-21', 'test', 'Male', 'Zach', 'Kotterer', 2, 3, NULL, 1, NULL, NULL, '29');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (3, '1987-07-04', 'daniel', 'Male', 'Daniel', 'Schulenberg', 3, 4, NULL, 1, NULL, NULL, '35');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (4, '1994-08-12', 'james', 'Male', 'James', 'Ferro', 4, 5, NULL, 1, NULL, NULL, '28');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (5, '1985-06-12', 'carmen', 'Female', 'Carmen', 'Electra', 5, 6, NULL, 1, NULL, NULL, '33');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (6, '1970-02-07', 'brad', 'Male', 'Brad', 'Pitt', 6, 7, NULL, 1, NULL, NULL, '33');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (7, '1980-03-12', 'brittney', 'Female', 'Brittney', 'Spears', 7, 8, NULL, 1, NULL, NULL, '44');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (8, '1974-09-01', 'mike', 'Male', 'Mike', 'Myers', 8, 9, NULL, 1, NULL, NULL, '35');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (9, '1972-12-20', 'angelina', 'Female', 'Angelina', 'Jolie', 9, 10, NULL, 1, NULL, NULL, '54');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (10, '1973-04-20', 'tina', 'Female', 'Tina', 'Fey', 10, 11, NULL, 1, NULL, NULL, '33');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (11, '1983-08-27', 'ryan', 'Male', 'Ryan', 'Reynolds', 11, 12, NULL, 1, NULL, NULL, '44');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (12, '1985-10-06', 'blake', 'Female', 'Blake', 'Lively', 12, 13, NULL, 1, NULL, NULL, '55');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (13, '1972-08-06', 'steve', 'Male', 'Steve', 'Carrel', 13, 14, NULL, 1, NULL, NULL, '65');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (14, '1986-09-16', 'jessica', 'Female', 'Jessica', 'Alba', 14, 15, NULL, 1, NULL, NULL, '43');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (15, '1972-01-09', 'matt', 'Male', 'Matt', 'Damon', 15, 16, NULL, 1, NULL, NULL, '33');
INSERT INTO `profile` (`id`, `birthday`, `description`, `sex`, `first_name`, `last_name`, `user_id`, `address_id`, `profile_pic`, `active`, `created_on`, `updated_on`, `age`) VALUES (16, '1983-05-12', 'scarlett', 'Female', 'Scarlett', 'Johansen', 16, 17, NULL, 1, NULL, NULL, '44');
